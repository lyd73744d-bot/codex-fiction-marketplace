...
const POLICY_VERSION = "natural-prose-v8";
...
function buildDraftSystem({ system = "", kind = "draft", taskLabel = "" } = {}) {
  ...
  const policy = [
    ...
    "首稿表达限制：正文中不要使用“不是……而是……”“并非……而是……”这类替读者下结论的对照句式；不要用破折号“——”制造转折、强调或解释。禁用空泛的“算账”“这笔账”“该收了”“该算账”“压力”“施压”“层层加码”，以及“声音密得像有人在拿沙袋往木板上倒”“目光如炬”“声音如钟”“雪花纷扬如鹅毛”“远山如黛”等现成套话。让动作、对话和前后文自己形成对照。",
